/* Questions:a, b and c are based on the following two
...
/*	a. Imagine you are getting the above users
 collection from a MongoDB database. 

a. Create a function called ***signUp*** which allows
 user to add to the collection. If user exists, inform
...
/* b. Create a function called ***signIn*** which allows
 user to sign in to the application
*/
const email = "bhavik252patel@gmail.com";
const password = "Bhavik@252";
...
/*b. The products array has  three elements and each
 of them has six properties. 
    a. Create a function called ***rateProduct*** which
    rates the product*/

const newRate = { userId: "patei2f", rate: 4 };
...
rateProduct(products, "bhav25d", newRate);
    
/* b. Create a function called ***averageRating*** 
...
This function will helps to like to the product if
 ...
 function likeProduct(products, productId, userId) {
  ...
  likeProduct(products, "hedfcg", "patei2f");